...
plot_N_tests(fig,"Conexion larga sin codo/Pasan", sensirion=True,flux=True,all=True, color='yellow',show=False)

fig= plt.figure()
plt.title("Vol vs tiempo")
plot_N_tests(fig,"Conexion larga sin codo/Pasan", vol=True,all=True, color='red',show=False)
